...
export default async function Search() {
    return (<form action='/search' method="GET" className="flex items-stretch h-10">
...
<Input type="search" name="q"  placeholder={`Search Site ${APP_NAME}`} className="flex-1 rounded-none dark:border-gray-200 bg-gray-100 text-black text-base h-full"/>
