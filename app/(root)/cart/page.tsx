  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-4 md:gap-4">
        {items.length === 0 ? (
          <Card className="span-cols-4 rounded-none">
            <CardHeader className="text-3xl">Your Cart is Empty</CardHeader>
            <CardContent>
          ...
          <>
            <div className="col-span-3">
              <Card className="rounded-none">
                <CardHeader className="text-3xl">Shopping Cart</CardHeader>
                <CardContent className="p-4">
                  <div className="flex justify-end border-b mb-4">Price</div>
                  {items.map((item) => (
                    <div
                      key={item.clientId}
                      className="flex flex-col md:flex-col justify-between py-4 border-b gap-4"
                    >
                  ...
                  {itemsPrice < FREE_SHIPPING_MIN_PRICE ? (
                    <div>
                      <div className="flex-1">
                        ...
                        of eligible items to get free shipping
                      </div>
                    </div>
                  ) : (
                    <div className="flex-1">
